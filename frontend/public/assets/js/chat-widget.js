...
(function() {
  ...
  waBtn.style.cssText = 'position:fixed;bottom:5.5rem;right:1.5rem;width:52px;height:52px;background:#25D366;border-radius:50%;display:flex;align-items:center;justify-content:center;box-shadow:0 4px 16px rgba(37,211,102,0.45);z-index:997;transition:transform 0.2s,box-shadow 0.2s;text-decoration:none;';
